...
import type { LockFile, ProjectConfig, MermaidRenderConfig } from "#domain/config/types";
...
class SelectiveRenderer implements Renderer {
	async render(source: string, config: MermaidRenderConfig): Promise<Result<Artifact, MarkSyncError>> {
