...
| 5 — Live-sandbox E2E harness | Completed | 2026-07-15T20:10:00Z | 2026-07-15T20:25:00Z | 71772ae | Thin runner + guarded smoke test created. helpers.ts with REQUIRED_E2E_VARS + requiredSecretsPresent() guard (RSK-6). CleanupTracker class for run-scoped deletion. sandbox-guard.test.ts validates skip path. sandbox-smoke.test.ts placeholder for create+read+delete. Exit 0 without secrets verified. run-e2e.yml unchanged (NG-6). |
