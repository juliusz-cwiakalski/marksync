...
- `GET /wiki/rest/api/content/{pageId}/property/{key}` → 200 `{ key, value, version:{number} }` (value is a string); 404 → property absent (`ok(undefined)`).
