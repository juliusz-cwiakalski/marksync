...
| `doc/decisions/ADR-0003-product-naming-confluence-adapter.md` | decision record | author | Product naming & architecture. | 1, 3 | "MarkSync" core + Confluence adapter; naming. |
| `doc/decisions/ADR-0004-confluence-api-validation-spike.md` | decision record | author | Decision to run a scoped Confluence API validation spike. | 3 | Spike scope/charter; now largely executed (see integration scenarios). |
